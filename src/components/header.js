      ...
      <>
          ...
          <div className="container-md">
            ...
            >
              ...
              <a
                ...
                href="https://www.linkedin.com/in/akshaj-jagarapu"
                target="_blank"
                rel="noreferrer noopener"
              >
                <svg
              ...
              <a
                className="navbar-nav-svg text-dark pb-1 ps-1"
                href="https://github.com/askjag07"
                target="_blank"
                rel="noreferrer noopener"
              >
                <svg
        ...
        <footer className="justify-content-between shadow bg-dark text-center text-white pb-2 pt-3 px-4 row align-items-center">
          ...
          <span className="text-end col-sm-5">
            <a
              className="text-end d-inlinems-5 badge bg-danger mb-3"
              href="https://github.com/askjag07/virtuoso-app"
              target="_blank"
              rel="noreferrer noopener"
            >
            ...
            <a
              className="navbar-nav-svg text-danger mb-3 ps-2"
            ...
            <a
              className="navbar-nav-svg text-danger mb-3 ps-1"
              href="https://github.com/askjag07"
              target="_blank"
              rel="noreferrer noopener"
            >
